      ...
      <div class="card h-100 text-center">
        ...
        <div class="card-body d-flex flex-column px-1 py-3">
         ...
         <div class="card-footer p-1">
            ...
            <button data-id="${response._id}" id="deleteLesson" class="btn mb-1 mt-2 hide" data-bs-toggle="modal" data-bs-target="#deleteModal">
            ...
            <a href="${response.url}" class="btn btn-secondary btn-sm  mb-1 mt-2">View</a>

            <button data-id="${response._id}" id="editMdlBtn" type="button" class="btn mb-1 mt-2 hide" data-bs-toggle="modal" data-bs-target="#editModal">
