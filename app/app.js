...
const func = require('../app/teacherteach/func')
...
$(() => {
  ...
  // reset modal when open to show user empty forms
  ...
  // gets lesson id
  store.$myLessons.on('click', '.card', func.getLessonId)
})
